 ...
 */
definition(
        name: "DarkenBehindMe_Ins",
        namespace: "jesper",
        author: "Lwin Khin Shar",
        description: "this is an instrumented app",
        category: "My Apps",
...
def installed()
{
    state.resp = [] // instrumented code that initializes the response obj
